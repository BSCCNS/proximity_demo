...
cities = {'Barcelona, Spain': 'R347950',
          ...
          'As Salt, Jordan': 'W379038048',
          'Bodrum, Turkey': 'R1827275',
          'Genova, Italy': 'R44875',
          'Irbid, Jordan': 'R2925617',
          "M'Saken, Tunisia": 'R7150924',
          'Roskovec, Albania': 'R1251471',
          'Saida, Lebanon': 'R16414025',
          'Tripoli, Lebanon': 'R4869639',
          'Zarqa, Jordan': 'W379036545'
          }
...
st.markdown(
        ...
        <div style="display:flex;align-items:center;height:100%;">
            <h1 style="color:#003c74;margin:0;">Search by City Name</h1>
        </div>
        """,
...
city = st.selectbox("Select a city from the list of registered users", options=cities.keys(), index=None,
...
if com and not city:
    st.markdown('Please, choose a city from the list.')
    

if city and custom_bins and com and poi:  
